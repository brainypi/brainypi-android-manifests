...
RUN apt-get update -y && apt-get install -y openjdk-8-jdk python git-core gnupg flex bison gperf build-essential liblz4-tool zlib1g-dev gcc-multilib g++-multilib libc6-dev-i386 \
